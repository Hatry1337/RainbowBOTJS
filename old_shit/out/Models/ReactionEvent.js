...
], ReactionEvent.prototype, "UserID", void 0);
__decorate([
    sequelize_typescript_1.Column({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: false,
...
__decorate([
    sequelize_typescript_1.Column({
        type: sequelize_typescript_1.DataType.ENUM("AddRole", "RemoveRole", "SendMessage"),
        allowNull: false,
    }),
    __metadata("design:type", String)
], ReactionEvent.prototype, "Action", void 0);
__decorate([
    sequelize_typescript_1.Column({
...
], ReactionEvent.prototype, "ActionParams", void 0);
