...
class RoleByReact {
    constructor(controller) {
        this.Name = "RoleByReact";
        this.Trigger = "!rolebyreact";
        this.Usage = "`!rolebyreact <message_id> @role <emoji>`\n\n" +
            "**Examples:**\n" +
        ...
        this.Description = "Using this command admins can create .";
        this.Category = "Info";
...
module.exports = RoleByReact;
//# sourceMappingURL=RoleByReact.js.map