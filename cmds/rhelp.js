...
function rhelp(message, Discord) {
    emb = new Discord.MessageEmbed()
        ...
        .addFields([
            ...
            //{ name : "!like_hentai <номер картинки>", value : "Поставить лайк на указаную картинку.", inline: true},
            //{ name : "!hentai_list <номер страницы>", value : "Показать список всех хентай картинок.", inline: true},
