...
function shop(message, client, Discord, db, gu) {
    gu(message.author.id, function (user) {
        ...
        emb = new Discord.RichEmbed()
            ...
            .addField("Битмайнеры:", `
            1. Bitminer S1 - 4.000 Поинтов в час. Цена ${bs1_pr} Поинтов
            2. Bitminer S2 - 9.000 Поинтов в час. Цена ${bs2_pr} Поинтов
            3. Bitminer Rack - 20.000 Поинтов в час. Цена ${br_pr} Поинтов
            4. Датацентр с битмайнерами - 100.000 Поинтов в час. Цена ${brd_pr} Поинтов`)
            .addField("Бизнесы:", `5. Солнечная электростанция - 20 опыта в час + 10.000 Поинтов в час. Цена ${ss_pr} Поинтов`)
