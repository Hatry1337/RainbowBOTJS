                ...
                .addFields([
                    {
                        name: "Битмайнеры:",
                        value:
                            `1. Bitminer S1 - 4.320 Поинтов в час. Цена ${Math.floor(bs1_pr)} Поинтов\n`+
                            `2. Bitminer S2 - 9.000 Поинтов в час. Цена ${Math.floor(bs2_pr)} Поинтов\n`+
                            `3. Bitminer Rack - 20.160 Поинтов в час. Цена ${Math.floor(br_pr)} Поинтов\n`+
                            `4. Датацентр с битмайнерами - 100.080 Поинтов в час. Цена ${Math.floor(brd_pr)} Поинтов\n`
                    },
                    { name: "Бизнесы:",     value: `5. Солнечная электростанция - 21.6 опыта в час + 10.080 Поинтов в час. Цена ${Math.floor(ss_pr)} Поинтов`},
